...
cd "$TARGET"
git clone git@github.com:banool/bunkopepi.git .
...
sudo certbot --nginx -n -m danielporteous1@gmail.com --agree-tos --redirect -d "bunkopepi.$DOMAIN"
