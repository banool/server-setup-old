...
cd "$TARGET"
git clone git@github.com:banool/adport-internode.git .
...
sudo certbot --nginx -n -m danielporteous1@gmail.com --agree-tos --redirect -d "internode.$DOMAIN"
